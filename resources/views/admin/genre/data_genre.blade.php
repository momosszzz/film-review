...
<div class="mb-4 flex items-center gap-4">    
  <a href="{{ url('/tambah_genre') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah</a>
</div>
@if(session('error'))
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200">
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr>
              <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-center">{{ $genre->id_genre }}</td>
              <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center">{{ $genre->nama_genre }}</td>
