...
<div class="mb-4 flex items-center gap-4">    
  <a href="{{ url('/tambah_tahun') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah</a>
</div>
@if(session('error'))
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200">
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr>
              <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-center">{{ $tahun->id_tahun }}</td>
              <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center">{{ $tahun->tahun_rilis }}</td>
              <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center"><span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                ...
                <form action="{{ url('tahun/delete') }}" method="POST">
                  @method('DELETE')
                  @csrf
